...
$body = "
		...
		<br><br>
		Voc&ecirc; foi cadastrado(a), Acesse seu escrit&oacute;rio virtual da ComunidadeMultiN&iacute;vel para ver os videos e artigos explicativos de como funciona todo o projeto:  <a href='http://www.comunidademultinivel.com.br/trafficmonsoon/home'>http://www.comunidademultinivel.com.br/trafficmonsoon/home</a> 
		<br><br>
		...
		<br><br>   
		Para maiores Informa&ccedil;&otilde;es Acesse, Agora mesmo nosso site: <a href='http://www.comunidademultinivel.com.br/trafficmonsoon/'>http://www.comunidademultinivel.com.br/trafficmonsoon/</a>. 
...
$mail->AltBody = " 
		...
		A ComunidadeMultiN&iacute;vel trabalha com estrat&eacute;gias que facilitam o seu crescimento dentro de uma empresa de Marketing MultiN&iacute;vel totalmente legalizada.
		 ...
		 Uma dessas estrat&eacute;gias de trabalho &eacute; a ferramenta de trabalho 'Dicas Di&aacute;rias' que est&aacute; sendo um sucesso, essa ferramenta de trabalho, possibilita para voc&ecirc; e todos seus indicados diretos e indiretos serem FINANCIADOS para entrarem em uma empresa de Marketing MultiN&iacute;vel totalmente legalizada. Voc&ecirc; j&aacute; imaginou como seria f&aacute;cil criar uma rede de afil&iacute;ados em uma empresa de MMN, sendo que todos seus indicados diretos e indiretos sejam FINANCIADOS ? 
	 
		Voc&ecirc; foi Indicado Diretamente por: <b>$nome_patrocinador</b>, contate e converse com essa pessoa, para que ela possa lhe explicar a grandiosidade de todo nosso projeto.
	  
		Para maiores Informa&ccedil;&otilde;es Acesse, Agora mesmo nosso site:  http://www.comunidademultinivel.com.br/trafficmonsoon/   
		Acesse tamb&eacute;m seu escrit&oacute;rio virtual, que se encontra no topo do site. 
    ...
    if (!$mail->send()) {
        ...
        if ($qts_ip >= 3) {  
			  ...
			  // mensagem de advertencia
				echo "<script type='text/javascript'> alert('Cadastrado com Sucesso, OCORREU UM ERRO AO ENVIAR UM E-MAIL, CONTATE-NOS, ATEN\u00c7AO: UMA ADVERT\u00caNCIA FOI REGISTRADA PARA SEU PATROCINADOR, \u00c9 CONTRA OS TERMOS DE USO DA COMUNIDADEMULTIN\u00cdVEL EFETUAR V\u00c1RIOS CADASTROS ATRAV\u00c9S DA MESMA M\u00c1QUINA DE ACESSO(PC, NOTBOOK, IP..etc), CASO VOC\u00ca OU SEU PATROCINADOR TENHA MOTIVOS PARA PROVAR QUE ESSA ADVERT\u00caNCIA FOI DESNECESS\u00c1RIA, CONTATE-NOS, LOG: $erro !!!'); location.href='como-ganhar-mais-dinheiro';</script>";
				exit;
			} else {
				//  mensagem com sucesso 
				echo "<script type='text/javascript'> alert('Cadastrado com Sucesso, OCORREU UM ERRO AO ENVIAR UM E-MAIL, CONTATE-NOS, LOG: $erro !!!'); location.href='como-ganhar-mais-dinheiro';</script>";
				exit;
			} 
        break; //Abandon sending
 		...
 		if ($qts_ip >= 3) {  
				...
				$cadastra = $run->execute($dados); 
			  // mensagem de advertencia
				echo "<script type='text/javascript'> alert('Cadastrado com Sucesso, Veja no seu E-mail ou acesso seu escrit\u00f3rio virtual agora mesmo, ATEN\u00c7AO: UMA ADVERT\u00caNCIA FOI REGISTRADA PARA SEU PATROCINADOR, \u00c9 CONTRA OS TERMOS DE USO DA COMUNIDADEMULTIN\u00cdVEL EFETUAR V\u00c1RIOS CADASTROS ATRAV\u00c9S DA MESMA M\u00c1QUINA DE ACESSO, CASO VOC\u00ca OU SEU PATROCINADOR TENHA MOTIVOS PARA PROVAR QUE ESSA ADVERT\u00caNCIA FOI DESNECESS\u00c1RIA, CONTATE-NOS !!!'); location.href='como-ganhar-mais-dinheiro';</script>";
				exit;
			} else {
				//  mensagem com sucesso 
				echo "<script type='text/javascript'> alert('Cadastrado com Sucesso, Veja no seu E-mail ou acesso seu escrit\u00f3rio virtual agora mesmo !!!'); location.href='como-ganhar-mais-dinheiro';</script>";
				exit;
			} 
    }
