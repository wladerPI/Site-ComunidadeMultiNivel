...
<head>
    ...
    <title>TrafficMonsoon Essa P&aacute;gina n&atilde;o existe. </title> 
        ...
        <div class="container"> 
            <div class="row"> 
                <div class="col-md-12 text-center">
                    <h1 class="section-title" style="font-size:20px;color:red;">Desculpe, essa p&aacute;gina n&atilde;o existe</h1>
                </div> <!-- /.col-md-12 -->
 
 <div style="text-align:center;">	
	<img src="images/erro404-pagina-nao-pode-ser-encontrada-erro-na-pagina.jpg" alt="ERRO NA PAGINA" style="width:300px;border:3px solid #000;" > 
</div>
