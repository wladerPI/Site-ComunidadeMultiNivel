...
<head>
    ...
    <title>TrafficMonsoon produtos, pacotes (Adpack) de divulga&ccedil;&atilde;o, Como Funciona e como ganhar dinheiro com publicidades, umas das maiores empresas de PTCs do mundo, Comunidade MultiN&iacute;vel </title> 
        ...
        <div class="container"> 
            <div class="row"> 
                <div class="col-md-12 text-center">
                    <h1 class="section-title" style="font-size:20px;">Conhe&ccedil;a os produtos da TRAFFICMONSOON</h1>
                </div> <!-- /.col-md-12 -->
                        ...
                        <div class="item-thumb"> 
                            <div class="overlay">
                                <div class="overlay-inner">
                                    <a href="produto/troca-de-trafego-digital.php" title="Como Funciona Troca de Tr&aacute;fego Digital" class="view-detail">Saiba Mais</a>
                                </div>
                            </div> <!-- /.overlay -->
                            <img style="border:3px solid #000;" src="images/products/trafficmonsoon-produtos-como-funciona-troca-de-trafego-comunidade-multinivel.png" alt="Como Funciona Troca de Tr&aacute;fego Digital">
                        </div> <!-- /.item-thumb -->
                         <h3>Troca de Tr&aacute;fego Digital</h3>
                        <span>Valor da Compra <em class="h3">GRATUITO</em></span>
                    </div> <!-- /.product-item -->
                </div> <!-- /.col-md-3 -->  
                ...
                <div class="col-md-3 col-sm-6">
                  <div class="product-item">
                        <div class="item-thumb">
                            <div class="overlay">
                                <div class="overlay-inner">
                                    <a href="produto/adPack-com-compartilhamento-de-lucro.php" title="Como Funciona AdPack Com Compartilhamento de Lucro" class="view-detail">Saiba Mais</a>
                                </div>
                            </div> <!-- /.overlay -->
                            <img style="border:3px solid #000;" src="images/products/TrafficMonsoon-como-funciona-os-adpacks-com-compartilhamento-de-lucro-comunidade-multinivel.png" alt="Como Funciona AdPack Com Compartilhamento de Lucro">
                        </div> <!-- /.item-thumb -->
                    <h3>AdPack Com Compartilhamento de Lucro</h3>
                ...
                <div class="col-md-3 col-sm-6">
                    <div class="product-item">
                        <div class="item-thumb"> 
                            <div class="overlay">
                                <div class="overlay-inner">
                                    <a href="produto/cash-links.php" title="Como Funciona Cash Links (PTC)" class="view-detail">Saiba Mais</a>
                                </div>
                            </div> <!-- /.overlay -->
                            <img style="border:3px solid #000;" src="images/products/trafficmonsoon-cash-link-adpack-como-funciona-comunidade-multinivel.png" alt="Como Funciona Cash Links (PTC) ">
                        </div> <!-- /.item-thumb -->
                        <h3>Cash Links (PTC)</h3>
                        <span>Valor da Compra <em class="h3">&#36;1.00</em></span>
                    </div> <!-- /.product-item -->
                </div> <!-- /.col-md-3 -->
                ...
                <div class="col-md-3 col-sm-6">
                  <div class="product-item">
                        <div class="item-thumb"> 
                            <div class="overlay">
                                <div class="overlay-inner">
                                    <a href="produto/creditos_visualizacoes.php" title="Como Funciona Cr&eacute;ditos de Visualiza&ccedil;&otilde;es" class="view-detail">Saiba Mais</a>
                                </div>
                            </div> <!-- /.overlay -->
                            <img style="border:3px solid #000;" src="images/products/trafficmonsoon-creditos-de-visualizacao-produtos-como-funciona-valor-adpack-comunidade-multinivel.png" alt="Como Funciona Cr&eacute;ditos de Visualiza&ccedil;&otilde;es">
                        </div> <!-- /.item-thumb -->
                    <h3>Cr&eacute;ditos de Visualiza&ccedil;&otilde;es</h3>
                        <span>Valor da Compra <em class="h3">&#36;5.95 / &#36;449.95</em></span>
                    </div> 
                    <!-- /.product-item -->
                </div> <!-- /.col-md-3 -->
				 ...
				 <div class="col-md-3 col-sm-6">
                  <div class="product-item">
                        <div class="item-thumb"> 
                            <div class="overlay">
                                <div class="overlay-inner">
                                    <a href="produto/buy-start-pages.php" title="Como Funciona Buy Start Pages" class="view-detail">Saiba Mais</a>
                                </div>
                            </div> <!-- /.overlay -->
                            <img style="border:3px solid #000;" src="images/products/trafficmonsoon-Buy-Start-Pages-como-funciona-produtos-comunidade-multinivel.png" alt="Como Funciona Buy Start Pages">
                        </div> <!-- /.item-thumb -->
                    <h3>Buy Start Pages</h3>
                        <span>Valor da Compra <em class="h3">&#36;35.00</em></span>
                    </div> 
                    <!-- /.product-item -->
                </div> <!-- /.col-md-3 -->
				 ...
				 <div class="col-md-3 col-sm-6">
                  <div class="product-item">
                        <div class="item-thumb"> 
                            <div class="overlay">
                                <div class="overlay-inner">
                                    <a href="produto/buy-login-ads.php" title="Como Funciona Buy Login Ads" class="view-detail">Saiba Mais</a>
                                </div>
                            </div> <!-- /.overlay -->
                            <img style="border:3px solid #000;" src="images/products/trafficmonsoon-Buy-Login-Ads-com-funciona-produtos-comunidade-multinivel.png" alt="Como Funciona Buy Login Ads">
                        </div> <!-- /.item-thumb -->
                    <h3>Buy Login Ads</h3>
                        <span>Valor da Compra <em class="h3">&#36;35.00</em></span>
                    </div> 
				...
				<div class="col-md-3 col-sm-6">
                  <div class="product-item">
                        <div class="item-thumb"> 
                            <div class="overlay">
                                <div class="overlay-inner">
                                    <a href="produto/text-ads.php" title="Como Funciona Text Ads" class="view-detail">Saiba Mais</a>
                                </div>
                            </div> <!-- /.overlay -->
                            <img style="border:3px solid #000;" src="images/products/trafficmonsoon-text-ads-adpack-como-funciona-comunidade-multinivel.jpg" alt="Como Funciona Text Ads">
                        </div> <!-- /.item-thumb -->
                    <h3>Text Ads</h3>
                        <span>Valor da Compra <em class="h3">&#36;10.00</em></span>
                    </div> 
                    <!-- /.product-item -->
                </div> <!-- /.col-md-3 -->
