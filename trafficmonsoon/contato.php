...
<head>
    ...
    <title>TrafficMonsoon entre em contato com a equipe da Comunidade MultiN&iacute;vel </title> 
	...
	<META NAME="keywords" CONTENT="contato, fale conosco, Como Funciona TrafficMonsoon, empresas de PTCs, melhores equipe de PTC, empresas de publicidade, ganhar dinheiro com PTC, ganhar dinheiro no MMN, TrafficMonsoon funciona, TrafficMonsoon piramide financeira">
        ...
        <div class="container"> 
            <div class="row"> 
                <div class="col-md-12 text-center">
                    <h1 class="section-title" style="font-size:20px;">Entre em contato com equipe da Comunidade MULTIN&Iacute;vel</h1>
                </div> <!-- /.col-md-12 -->
...
<div class="article"> 
    <p class="infopost" style="text-align:center;">Envei um e-email, responderemos assim que poss&iacute;vel.</p>
    <div class="clr"></div>
    <div class="img"style="text-align:center;"><img src="images/contato.jpg" width="620" height="154" alt="" class="fl" /></div>
			...
			<form action="enviar.php" method="post" id="form" name="form">
				<ol>
					<li>
						...
						<input style="background:#e6eff6;font-size:20px;" id="name" name="name" class="text" />
					</li>
					<li>
						<label for="email">Email*</label>
						<input style="background:#e6eff6;font-size:20px;" id="email" name="email" class="text" />
					</li> 
					<li>
						<label for="message">Digite sua Mensagem*</label>
						<textarea style="background:#e6eff6;font-size:20px;" id="message" name="message" rows="8" cols="50"></textarea>
					</li>
					<li>
						<input type="submit" name="imageField" style="background:#298d15;color:#FFF;border:2px solid #0f3661; " value="Enviar" Onclick="return verifica()"  />
						<div class="clr"></div>
					</li>
				</ol>
          </form>
