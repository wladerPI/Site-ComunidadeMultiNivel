            ...
            <aside class="right-side">
                ...
                <section class="content-header">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="active">Todos Clientes do Sistema</li>
                    </ol>
                </section>
                <!-- Main content -->
...
<!-- centro -->		 
 <div class="box-header">
		<h3 class="box-title">Todos Clientes do Sistema</h3>
</div><!-- /.box-header -->	 
<div class="box box-primary"> 
	...
	<section class="content"> 
                    <div class="row"> 
						<div class="col-xs-12"> 
							<i>Ordem de Alfab&eacute;tica</i>
                            <div class="box"> 
...
//######### FIM dados Paginação
	...
	$sql = $con->prepare("SELECT * FROM $tabela3 ORDER BY NOME ASC LIMIT $inicial, $numreg");
	$sql->execute();
...
?>
	<tbody>
        <tr>
						<td> 
							<?php if ($ln_verifc->FOTO_PERFIL == "") { ?>
								<a href="completo.php?id_clients=<?php echo $ln_verifc->ID; ?>" title="Veja o Perfil Completo do(a) <?php echo $ln_verifc->NOME; ?>"><img src="../../adm_clientes/img_perfil/sem_foto.png"  class="img-circle" alt="Sua Imagem" width="70" /> </a>
							<?php } else { ?>
								<a href="completo.php?id_clients=<?php echo $ln_verifc->ID; ?>" title="Veja o Perfil Completo do(a) <?php echo $ln_verifc->NOME; ?>"><img src="../../adm_clientes/img_perfil/<?php echo $ln_verifc->FOTO_PERFIL; ?>"  class="img-circle" width="70" alt="Sua Imagem" /></a>
							<?php } ?>
						</td>
						<td class='class1'><?php echo $ln_verifc->ID; ?></td> 
						<td class='class2'> <?php echo $ln_verifc->NOME; ?></td> 
						<td class='class2'> <?php echo $ln_verifc->CIDADE; ?></td>
						<td class='class2'> <?php echo $ln_verifc->EMAIL; ?></td>
						<td class='class2'> <?php echo $ln_verifc->PONTOS; ?></td>
						<td class='class2'> <?php echo $ln_verifc->TALK_FUSION; ?></td>
						<td class='class2'> <?php echo $ln_verifc->AGN; ?></td>
					</tr>	
    </tbody>  	 
				<?php }  ?> 
<tfoot> 
