            ...
            <aside class="right-side">
                ...
                <section class="content-header">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="active">Pomo&ccedil;&atilde;o BRINDES PAGOS</li>
                    </ol>
                </section>
                <!-- Main content -->
...
<!-- centro -->		 
 <div class="box-header">
		<h3 class="box-title">Pomo&ccedil;&atilde;o BRINDES PAGOS</h3>
</div><!-- /.box-header -->	 
...
//######### FIM dados Paginação
	...
	$sql = $con->prepare("SELECT * FROM $tabela25 WHERE STATUS = 'PAGO' ORDER BY ID desc LIMIT $inicial, $numreg");
	$sql->execute();
	$sql_verifc = $sql->fetchAll(PDO::FETCH_OBJ);
	$quantreg_pendentes = count( $sql_verifc );
	 
	
	$sql_conta_repetidos = $con->prepare("SELECT * FROM $tabela25 WHERE STATUS = 'PAGO'");
...
?> 
	...
	<div class="alert alert-warning alert-dismissable">
        ...
        <b> At&eacute; o momento (<?php echo $qts_premiados_pagos; ?>) Adpacks da empresa TrafficMonsoon, foram FINANCIADOS para os afil&iacute;ados da Comunidade MultiN&iacute;vel. </b>
    </div>
	...
	echo "<br><br>"; // Vai servir só para dar uma linha de espaço entre a paginação e o conteúdo
				...
				foreach($sql_verifc as $ln_verifc) { 
					...
					$qts_adpacks = $ln_verifc->QTS_ADPACKS_BRINDES; 
...
?>
	<tbody>
        <tr> 
						...
						<td class='class2'> <?php echo $qts_adpacks; ?></td> 
						<td class='class2'> <?php echo $status; ?></td> 
						<td class='class2'> <?php echo $data_brindes; ?></td> 
					</tr>	
    </tbody>  	 
				<?php }  ?> 
<tfoot> 
