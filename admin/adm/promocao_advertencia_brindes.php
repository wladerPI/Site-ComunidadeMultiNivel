...
$advertencia = "Advertencia de brindes de ADPacks";
$dia = date('Y-m-d');
...
$body = "
			...
			<br><br> 
			<i style='color:red;'>Os Moderadores da ComunidadeMultiN&iacute;vel registraram uma advert&ecirc;ncia para voc&ecirc;, devido alguma viola&ccedil;&atilde;o das regras da promo&ccedil;&atilde;o  'Compre ADPacks na empresa TrafficMonsoon e ganhe at&eacute; +10 ADPacks de BRINDEs'.</i>
			<br><br>  
			<a href='http://www.comunidademultinivel/adm_clientes/promocao_brindes_regras.php' title='Para ler as Regras Voc&ecirc; precisa estar LOGADO no escrit&oacute;rio da ComunidadeMultiN&iacute;vel'>Clique aqui</a> e leia as Regras (LINK): http://www.comunidademultinivel/adm_clientes/promocao_brindes_regras.php
			<br> <br> 
...
$mail->AltBody = "
			Ol&aacute;  $nomecliente.
			 ...
			 Os Moderadores da ComunidadeMultiN&iacute;vel registraram uma advert&ecirc;ncia para voc&ecirc;, devido alguma viola&ccedil;&atilde;o das regras da promo&ccedil;&atilde;o  'Compre ADPacks na empresa TrafficMonsoon e ganhe at&eacute; +10 ADPacks de BRINDEs'. 
			  
			 http://www.comunidademultinivel/adm_clientes/promocao_brindes_regras.php Para ler as Regras Voc&ecirc; precisa estar LOGADO no escrit&oacute;rio da ComunidadeMultiN&iacute;vel 
