            ...
            <aside class="right-side">
                ...
                <section class="content-header">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="active">Pomo&ccedil;&atilde;o Premiados PAGOS</li>
                    </ol>
                </section>
                <!-- Main content -->
...
<!-- centro -->		 
 <div class="box-header">
		<h3 class="box-title">Pomo&ccedil;&atilde;o Premiados PAGOS</h3>
</div><!-- /.box-header -->	 
...
//######### FIM dados Paginação
	...
	$sql = $con->prepare("SELECT * FROM $tabela23 WHERE STATUS = 'PAGO' ORDER BY ID desc LIMIT $inicial, $numreg");
	$sql->execute();
	$sql_verifc = $sql->fetchAll(PDO::FETCH_OBJ);
	$quantreg_pendentes = count( $sql_verifc );
	 
	
	$sql_conta_repetidos = $con->prepare("SELECT * FROM $tabela23 WHERE STATUS = 'PAGO'");
...
?>
	<tbody>
        <tr> 
						...
						<td class='class2'> <?php echo $ln_verifc->DATA; ?></td> 
					</tr>	
    </tbody>  	 
				<?php }  ?> 
<tfoot> 
