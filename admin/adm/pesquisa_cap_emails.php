            ...
            <aside class="right-side">
                ...
                <section class="content-header">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="active">Pesquisar E-mail Capturados</li>
                    </ol>
                </section>
                <!-- Main content -->
...
<!-- centro -->		 
 <div class="box-header">
		<h3 class="box-title">Pesquisar E-mails Capturados</h3>
</div><!-- /.box-header -->	  
<div class="box box-primary">
		<label for="exampleInputEmail1"><form name="frmMudar" method="post">
			 Pesquisar Email por: <select name="sltMudar" onchange="fMudarPagina()" class="form-control">
				...
				<option value="emails.php">Mostrar E-mails Capturados
		...
		<br>
		<div id="por_nome">
			<label for="exampleInputEmail1">Pesquisar por Email: </label> <i class="fa fa-envelope"></i>  <input type="text" class="form-control"  placeholder="Digite o Email" name="busca_cap_emails" id="busca_cap_emails" class="pesnormal" onKeyUp="escondeAdm(1); setarCampos_busca_cap_emails(); enviarForm('busca_cap_emails.php', campos, 'divResultado');  return false;" /></label>
		</div> 
		<hr>
	<div id="adm1" style="visibility:hidden;"></div> 
	<div id="divResultado" style='visibility:hidden;'> </div>
</div><!-- /.box -->
