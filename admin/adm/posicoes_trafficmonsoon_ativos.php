            ...
            <aside class="right-side">
                ...
                <section class="content-header">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="active">Administrando Afiliados da TrafficMonsoon</li>
                    </ol>
                </section>
                <!-- Main content -->
...
<!-- centro -->		 
 <div class="box-header">
		<h3 class="box-title">Todas cadastros ATIVOs da TrafficMonsoon</h3>
</div><!-- /.box-header -->	 
...
//######### FIM dados Paginação
	...
	$sql = $con->prepare("SELECT * FROM $tabela22 WHERE STATUS = 'ATIVO' ORDER BY DATA_CADASTRO ASC LIMIT $inicial, $numreg");
	$sql->execute();
