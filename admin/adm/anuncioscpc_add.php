            ...
            <aside class="right-side">
                ...
                <section class="content-header">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="active">ADD An&aacute;ncios CPCs</li>
                    </ol>
                </section>
                <!-- Main content -->
		...
		return false;   
                        ...
                        <div class='col-md-12'>
                            <div class='box box-info'>
                                <div class='box-header'>
                                    <h3 class='box-title'>Criando An&uacute;ncios Custo por Clique <small> \O/ </small></h3>
                                    <!-- tools box -->
                                ...
                                <div class='box-body pad'>
									<form id="form_res" name="form_res" method="post" action="criando_anuncioscpc.php">
										...
										<div style="width:60%; float:right;"> 
											...
											<br>  
											<button type="submit" Onclick="return verifica()"  style="float:right;" class="btn btn-warning btn-lg" title="Clique aqui para Salvar a Dica">Salvar An&uacute;ncio</button> 
										</div>
									</form>
