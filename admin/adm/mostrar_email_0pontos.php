...
<!-- centro -->		 
 <div class="box-header">
		<h3 class="box-title">E-mails De clientes que possuem 0 pontos</h3>
</div><!-- /.box-header -->	 
<div class="box box-primary"> 
		<label for="exampleInputEmail1"><form name="frmMudar" method="post">
			 Pesquisar Email por: <select name="sltMudar" onchange="fMudarPagina()" class="form-control">
				...
				<option value="mostrar_email_clientes.php">Todos Clientes
			</select>
		</form></label> 
	<section class="content"> 
                    <div class="row"> 
...
//######### FIM dados Paginação
	...
	$sql = $con->prepare("SELECT * FROM $tabela3 WHERE PONTOS = '0' ORDER BY ID ASC LIMIT $inicial, $numreg");
	$sql->execute();
	$sql_verifc = $sql->fetchAll(PDO::FETCH_OBJ);
	
	$sql_conta = $con->prepare("SELECT * FROM $tabela3 WHERE PONTOS = '0' ");
	$sql_conta->execute();
...
?>
	<tbody>
        <tr>
						<td class='class1'><?php echo $ln_verifc->EMAIL; ?></td> 
