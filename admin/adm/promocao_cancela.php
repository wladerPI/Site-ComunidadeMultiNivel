...
$body = "
			...
			<br><br> 
			<i style='color:red;'>Os Moderadores da ComunidadeMultiN&iacute;vel CANCELARAM a troca de seus pontos por <b style='color:red;'> $troca_qtapacotes </b> ADPack(s) com posicionamento(s) de lucro da empresa TrafficMonsoon.</i>
			<br><br> 
			<b style='color:red;'> Uns dos Motivos do Cancelamento, pode ter sido a viola&ccedil;&atilde;o de alguma das regras da promo&ccedil;&atilde;o 'Troque seus Pontos por ADPacks da empresa TrafficMonsoon'    </b><br>
...
$mail->Subject = "Sua Solicitacao da troca de seus pontos por $troca_qtapacotes ADPacks foi CANCELADA !!!";
...
$mail->AltBody = "
			Ol&aacute;  $nomecliente.
			 ...
			 Os Moderadores da ComunidadeMultiN&iacute;vel CANCELARAM a troca de seus pontos por  $troca_qtapacotes   ADPack(s) com posicionamento(s) da empresa TrafficMonsoon. 
			 
			 Uns dos Motivos do Cancelamento, pode ter sido a viola&ccedil;&atilde;o de alguma das regras da promo&ccedil;&atilde;o 'Troque seus Pontos por ADPacks da empresa TrafficMonsoon'   
...
";
    ...
    if (!$mail->send()) {
		...
		echo "<script type='text/javascript'> alert('Troca CANCELADA com sucesso, ERRO ao enviar um email LOG: $erro !!!'); location.href='promocao_premiados_pendentes.php';</script>";
		exit;
    } else {
		echo "<script type='text/javascript'> alert('Troca CANCELADA com sucesso !!!'); location.href='promocao_premiados_pendentes.php';</script>";
		exit;
    }
