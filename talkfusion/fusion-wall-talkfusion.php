...
(adsbygoogle = window.adsbygoogle || []).push({});
        ...
        <div class="article">
			 ...
			 <div class="img"><img src="images/Fusion-Wall.jpg" width="300" height="200" alt="Fusion Wall " class="fl" /></div>
			 <h1 style="font-size:20px;">  Fusion Wall  </h1>
			 <p>Inteligente e criativo, o Fusion Wall apresenta o seu v&iacute;deo em um formato &uacute;nico: literalmente em uma parede de v&iacute;deos! Compartilhe sua hist&oacute;ria em v&iacute;deo com um site de rede social inteiramente novo e voltado para v&iacute;deos e apresente a sua mensagem para uma nova categoria de p&uacute;blico-alvo!</p>
			 <p>Quando voc&ecirc; marca seus v&iacute;deos do Fusion Wall, o SEO inicia e fica dispon&iacute;vel nos mecanismos de pesquisa na Internet. O Fusion Wall &eacute; a maneira mais otimizada para compartilhar conte&uacte;do de v&iacute;deo de entretenimento e informativos. Publique demonstra&ccedil;&atilde;es por v&iacute;deo, compartilhe promo&ccedil;&otilde;es de produtos e servi&ccedil;os, ou simplesmente conte uma hist&oacute;ria sobre as f&eacute;rias mais incr&iacute;veis que voc&ecirc; j&aacute; teve.</p>
			  <B>Seja visto. Seja ouvido. Seja um sucesso!</B>
			 <br><br>
			 <b>Recursos e personaliza&ccedil;&atilde;o;</b> <br><br>
			 <div class="img"><img src="images/ceta.jpg" width="10" height="10" alt="Video profissional" class="fl" /> - Exponha sua marca para uma rede inteiramente nova.</div> <br class="clr">
			 <div class="img"><img src="images/ceta.jpg" width="10" height="10" alt="Video profissional" class="fl" /> - Envolva novos clientes em potencial e seus clientes atuais.</div> <br class="clr">
			 <div class="img"><img src="images/ceta.jpg" width="10" height="10" alt="Video profissional" class="fl" /> - Sensibilize as pessoas sobre suas causas e organiza&ccedil;&otilde;es favoritas.</div> <br class="clr">
			 <div class="img"><img src="images/ceta.jpg" width="10" height="10" alt="Video profissional" class="fl" /> - Descubra a inspira&ccedil;&atilde;o criativa dos outros.</div> <br class="clr">
			 <br> 
			 <div id="rede_sociais">
				<table>
					<tr>	
