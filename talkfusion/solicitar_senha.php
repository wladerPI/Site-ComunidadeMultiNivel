          ...
          <div class="post_content">
			<br>
             <form action="solicitando_senha" method="post" id="form" name="form">
				<label class="solicit_senha">Seu E-mail Cadastrado no Sistema*:  <input id="solicit_senha" name="solicit_senha" class="text" /> </label> 
				<input type="image" name="imageField" class="botsenha" value="Solicitar Senha" Onclick="return verifica()"  />
			  </form>
			  <br>
		  </div> 
          <div class="clr"></div>
