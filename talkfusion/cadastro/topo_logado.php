...
<!-- header logo: style can be found in header.less -->
        <header class="header">
            <a href="http://www.comunidademultinivel.com.br/talkfusion" class="logo">
            ...
            <nav class="navbar navbar-static-top" role="navigation"> 
				...
				<a class="login_talk" href="../../forum/index.php" title="Tire Todas Suas Duvidas no For&uacute;m Da ComunidadeMultiN&iacute;vel" target="_blank"> 
					<img  src="../../../adm_clientes/img/logo_forum_comunidademultinivel.png" width="40" height="40" alt="For&uacute;m da ComunidadeMultiN&iacute;vel"  /> 
				</a>  
				...
				<a class="login_talk" href="../../adm_clientes/index.php" title="Acesse sua &Aacute;rea restrita da ComunidadeMultiN&iacute;vel" target="_blank"> 
					<img  src="../../adm_clientes/img/logo_admin_comunidademultinivel.png" width="70" height="40" alt="&Aacute;rea restrita da ComunidadeMultiN&iacute;vel"  /> 
				</a> 
