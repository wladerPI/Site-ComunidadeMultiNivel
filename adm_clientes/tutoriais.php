...
<div class="box-header">
	<h3 class="box-title">Links Explicativos referente ao Projeto</h3>
</div><!-- /.box-header -->						 
<ul>
	<li> <a href="artigos/estrategia_principal.php" title="Entenda Como Funciona Nossa Estrat&eacute;gia Principal" target="_blank" >Como Funciona Nossa Estrat&eacute;gia Principal ?</a></li>
</ul>	
<!-- FIM centro -->						
                </section><!-- /.content -->
            </aside><!-- /.right-side -->
