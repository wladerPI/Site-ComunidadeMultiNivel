            ...
            <aside class="right-side">
                ...
                <section class="content-header">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="active">F&Oacute;RUM / T&oacute;picos Criados</li>
                    </ol>
                </section>
<?php	
// TOTAL DE TOPICOS				
...
//######### FIM dados Paginação
	$sql = $con->prepare("SELECT * FROM $tabela10 WHERE ID_CLIENTE = '$id_cliente' ORDER BY ID DESC LIMIT $inicial, $numreg");
	$sql->execute();
	$sql_verifc = $sql->fetchAll(PDO::FETCH_OBJ);
	
	$sql_conta = $con->prepare("SELECT * FROM $tabela10 WHERE ID_CLIENTE = '$id_cliente'");
	$sql_conta->execute();
...
if ($quantreg <= 0)	{
	echo "<i  >Voc&ecirc; ainda n&atilde;o criou nenhum t&oacute;picos no f&oacute;rum.</i> <br>";
} else {
?>	
 
		<i>Lista por ordem de ultimos t&oacute;picos criados.</i> <br>
<?php
