            ...
            <aside class="right-side">
                ...
                <section class="content-header">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="active">Indicados Diretos</li>
                    </ol>
                </section>
<?php	
// TOTAL DE PONTUACAO				
...
// TOTAL DE DIRETOS
try {
	$sql_td = $con->prepare("SELECT * FROM $tabela3 WHERE ID_INDICACAO = $id ORDER BY PONTOS DESC");
	$sql_td->execute();
...
//######### FIM dados Paginação
	...
	$sql = $con->prepare("SELECT * FROM $tabela3 WHERE ID_INDICACAO = $id ORDER BY PONTOS DESC LIMIT $inicial, $numreg");
	$sql->execute();
	...
	foreach($sql_verifc as $ln_td) {
		...
		try {
			$sql_td2 = $con->prepare("SELECT * FROM $tabela3 ORDER BY PONTOS DESC");
			$sql_td2->execute();
