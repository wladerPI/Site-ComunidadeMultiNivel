            ...
            <aside class="right-side">
                ...
                <section class="content-header">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="active">Regras da promo&ccedil;&atilde;o: 'Compre ADPacks na empresa TrafficMonsoon e ganhe at&eacute; +10 ADPacks de BRINDEs'</li>
                    </ol>
                </section>
...
<div class="box box-primary">
	<div class="box-header">
		<h3 class="box-title">Regras da promo&ccedil;&atilde;o: 'Compre ADPacks na empresa TrafficMonsoon e ganhe at&eacute; +10 ADPacks de BRINDEs'</h3>
    </div><!-- /.box-header --> 
	<br>
...
<BR>  
	<div class="alert alert-warning alert-dismissable">
		...
		<b>ATEN&Ccedil;&Atilde;O !!! </b> A promo&ccedil;&atilde;o do m&ecirc;s "Compre ADPacks na empresa TrafficMonsoon e ganhe at&eacute; +10 ADPacks de BRINDEs" est&aacute; temporariamente DESATIVADA.<br>
...
<?php }  ?>	
		...
		<div class="box-body">  
		<br>
		1 - Para voc&ecirc; ser premiado com pelo menos <?php echo $qts_adpacks_brinde1; ?> ADPack com posicionamento de lucro da empresa de publididade TrafficMonsoon, voc&ecirc; precisar&aacute; comprar no m&iacute;nimo <?php echo $qts_adpacks_comprar1; ?> ADPacks da empresa TrafficMonsoon. Lembrando que essas quantidades de ADPacks a ser COMPRADOS podem aumentar ou diminuir a qualquer momento, dependendo da propor&ccedil;&atilde;o do crescimento de toda a equipe.<br><br>
		...
		3 - Ao Fazer a Compra dos seus ADPacks na empresa TrafficMonsoon, voc&ecirc; ter&aacute; que efetuar a compra tudo de uma s&oacute; vez, exemplo: para voc&ecirc; ganhar o BRINDE de <?php echo $qts_adpacks_brinde10; ?> ADPacks, antes voc&ecirc; ter&aacute; que comprar <?php echo $qts_adpacks_comprar10 ; ?> ADPacks na TrafficMonsoon, efetuando a compra de todos os ADpacks de uma s&oacute; vez. Ap&oacute;s efetuar a compra, acesse o escrit&oacute;rio virtual da Comunidade MultiN&iacute;vel, selecione a quantidade de ADPacks que voc&ecirc; comprou e SOLICITE seu BRINDE, clicando no bot&atilde;o verde. Os moderadores da ComunidadeMultiN&iacute;vel ir&atilde;o certificar, se voc&ecirc; realmente efetuou a compra dos ADPacks. se estiver tudo ok, os moderadores entraram em contato com voc&ecirc;, para efetuar os procedimentos da transfer&ecirc;ncia do dinheiro para a compra dos seus ADPacks de BRINDES, o dinheiro ser&aacute; transfer&ecirc;rido para uns dos seguintes bancos virtuais, PAYPAL, PAYZA ou SolidTrust PAY. Esse procedimento pode demorar alguns dias.<br><br>
		...
		5 - Voc&ecirc; poder&aacute; ser premiado com quantas remessas de BRINDES desejar, basta efetuar a compra dos ADPacks exigido e SOLICITAR seu BRINDE no site da ComunidadeMultiN&iacute;vel, sempre seguindos todas as regras acima.<br><br>
		6 - Veja abaixo na tabela a quantidade de ADPacks exigidas a cada BRINDE(s) de premia&ccedil;&atilde;o.<br>
