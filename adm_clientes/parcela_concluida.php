...
try {
	...
	$empresa = "TALKFUSION";
	$dia = date('Y-m-d');
	$descricao = "Aguarde os procedimentos (6-10 dias &uacute;teis)";
	
	// grava a compra PENDENTE no BD 
	$run = $con->prepare("INSERT INTO $tabela12 (ID_CLIENTE, STATUS, EMPRESA, DESCRICAO, DATA_CADASTRO) VALUES (:ID_CLIENTE, :STATUS, :EMPRESA, :DESCRICAO, :DATA_CADASTRO)");
	$dados = array(':ID_CLIENTE' => $id_cliente, ':STATUS' => $status, ':EMPRESA' => $empresa, ':DESCRICAO' => $descricao, ':DATA_CADASTRO' => $dia);
...
$body = "
			...
			<br><br> 
			<i style='color:red;'>Um Afiliado(a), Solicitou o parcelamento via PAYPAL de um pacote de produto da empresa TALK FUSION.</i>
			<br>
			Certifique-se de que realmente o pagamento foi efetuado. Seu suporte ser&aacute; de grande importancia. <br>
			<br><br>
...
$mail->Subject = "Um Afiliado Efetuou o PARCELAMENTO no PAYPAL";
...
$mail->AltBody = "
			Prezado MODERADOR(a) da ComunidadeMultiN&iacute;vel.
			 ...
			 Um Afiliado(a), Solicitou o parcelamento via PAYPAL de um pacote de produto da empresa TALK FUSION. 
			 
			Certifique-se de que realmente o pagamento foi efetuado. Seu suporte ser&aacute; de grande importancia.  
...
<!-- BANNER --> 		
 <div class="alert alert-success alert-dismissable">
	<i class="fa fa-ban"></i> 
	<H2>Sua Compra e Parcelamento foi CONCLU&Iacute;DA com sucesso</H2>  
	<br> 
</div> 
<br><br>
