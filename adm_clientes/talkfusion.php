...
<html>
    ...
    <body class="skin-blue">
        <?php  include("topo_iframe.php"); ?>
        <div class="left-side sidebar-offcanvas collapse-left">  
        </div><!-- ./wrapper -->
...
<iframe width='100%' frameborder='0'  src='https://ssl.talkfusion.com/secure/app/login/tf.asp?lang=pt'></iframe>  
</div><!-- /.box -->
