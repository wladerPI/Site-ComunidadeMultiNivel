            ...
            <aside class="right-side">
                ...
                <section class="content-header">
                    ...
                    <ol class="breadcrumb">
						...
						<li class="active">Aprenda Como usar o produto Video-Share</li>
                    </ol>
                </section> 
                <!-- Main content -->
...
<div class="box-header">
	<h3 class="box-title">Como Usar o Video-Share ? </h3>
</div><!-- /.box-header -->	
 <br> 
 Compartilhe seus Videos Email e Videos Newsletter em mais de 200 redes s&oacute;cias atrav&eacute;s desta ferramenta da Talk Fusion.
 <br>
<iframe  class="video" width="853" height="480" src="//www.youtube.com/embed/7QsTnw1OAqY?showinfo=0" frameborder="0" allowfullscreen></iframe>
 <br>
<!-- FIM centro -->						
                </section><!-- /.content -->
            </aside><!-- /.right-side -->
