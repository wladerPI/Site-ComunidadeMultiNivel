            ...
            <aside class="right-side">
                ...
                <section class="content-header">
                    ...
                    <ol class="breadcrumb">
						...
						<li class="active">Aprenda Como usar o produto Formul&aacute;rios de Subscri&ccedil;&atilde;o e Resposta Autom&aacute;tica</li>
                    </ol>
                </section> 
                <!-- Main content -->
...
<div class="box-header">
	<h3 class="box-title">Como Usar o Formul&aacute;rios de Subscri&ccedil;&atilde;o e Resposta Autom&aacute;tica ? </h3>
</div><!-- /.box-header -->	
 <br>  
 Aprenda a usar esta fant&aacute;stica ferramenta da Talk Fusion, deixe seu negocio no piloto autom&aacute;tico e alavanque seus negocios.
 <br>
 <iframe class="video" width="840" height="480" src="//www.youtube.com/embed/OhY6oCVSlI0?showinfo=0" frameborder="0" allowfullscreen></iframe>
 <br>
<!-- FIM centro -->						
                </section><!-- /.content -->
            </aside><!-- /.right-side -->
