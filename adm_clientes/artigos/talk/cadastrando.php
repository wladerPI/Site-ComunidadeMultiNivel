            ...
            <aside class="right-side">
                ...
                <section class="content-header">
                    ...
                    <ol class="breadcrumb">
						...
						<li class="active">Procedimentos de cadastro na REDE PRINCIPAL da TALK FUSION</li>
                    </ol>
                </section> 
                <!-- Main content -->
...
<div class="box-header">
	<h3 class="box-title">Qual ser&aacute; o procedimentos de cadastro na REDE PRINCIPAL da TALK FUSION ? </h3>
</div><!-- /.box-header -->	
 <br> 	 
<iframe class="video" width="840" height="480" src="//www.youtube.com/embed/Lf4wn_mZPC8?showinfo=0" frameborder="0" allowfullscreen></iframe>
 <br>
<!-- FIM centro -->						
                </section><!-- /.content -->
            </aside><!-- /.right-side -->
