            ...
            <aside class="right-side">
                ...
                <section class="content-header">
                    ...
                    <ol class="breadcrumb">
						...
						<li class="active">Aprenda Como usar o produto Video-Email</li>
                    </ol>
                </section> 
                <!-- Main content -->
...
<div class="box-header">
	<h3 class="box-title">Como Usar o Video-Email ? </h3>
</div><!-- /.box-header -->	
 <br> 
<iframe class="video" width="840" height="480" src="//www.youtube.com/embed/QdWASdohC88?showinfo=0" frameborder="0" allowfullscreen></iframe>
<br>
 <div class="box-header">
