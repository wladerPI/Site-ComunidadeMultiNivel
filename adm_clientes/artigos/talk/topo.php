        ...
        <header class="header">
            ...
            <nav class="navbar navbar-static-top" role="navigation">
				...
				<a class="login_talk" href="../../../talkfusion" title="Saiba Mais Sobre a TALK FUSION" target="_blank"> 
					<img  src="../../img/icon_talkfusion.png" width="40" height="40" alt="LOGO TALK FUSION"  /> 
				</a> 
				
				<a class="login_talk" href="../../trafficmonsoon_site.php" title="Acessar Site Oficial da TrafficMonsoon" target="_blank"> 
					<img  src="../../img/logo-surf.png" width="80" height="40" alt="LOGO TrafficMonsoon"  /> 
				</a> 
				<a class="login_talk" href="../../../forum/index.php" title="Tire Todas Suas Duvidas no For&uacute;m Da ComunidadeMultiN&iacute;vel" target="_blank"> 
					<img  src="../../img/logo_forum_comunidademultinivel.png" width="40" height="40" alt="For&uacute;m da ComunidadeMultiN&iacute;vel"  /> 
				</a> 
				...
				<a class="login_talk" href="https://www.facebook.com/ComunidadeMultiNivel" title="P&aacute;gina oficial no Facebook da ComunidadeMultiN&iacute;vel" target="_blank"> 
					<img  src="../../img/pagina-facebook-comunidade-multinivel.png" width="40" height="40" alt="P&aacute;gina oficial no Facebook da ComunidadeMultiN&iacute;vel"  /> 
				</a> 
				<a class="login_talk" href="http://goo.gl/4zDgYr" title="Canal no YOUTUBE da ComunidadeMultiN&iacute;vel" target="_blank"> 
					<img  src="../../img/canal-yotube-comunidade-multinivel.png" width="40" height="40" alt="Canal no YOUTUBE da ComunidadeMultiN&iacute;vel"  /> 
				</a>  
