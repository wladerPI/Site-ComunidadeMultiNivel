...
$id_resposta_edit = $_POST["id_resposta"]; 
$url_edit = $_POST["url"]; 

try {
	$sql_verifc = $con->prepare("SELECT * FROM $tabela11 WHERE ID = $id_resposta_edit");
	$sql_verifc->execute();
	$res_verifc = $sql_verifc->fetchAll(PDO::FETCH_OBJ);
	foreach($res_verifc as $ln) { 
			$id_resposta = $ln->ID;
			$id_cliente_resposta =  $ln->ID_CLIENTE;
			$categoria_resposta =  $ln->CATEGORIA;  
			$texto_resposta =    html_entity_decode((string)$ln->TEXTO_TOPICO, ENT_QUOTES, 'utf-8');  
			$data = $ln->DATA_TOPICO;
...
if ($id_cliente != $id_cliente_edit) {
	echo("<script type='text/javascript'> alert('Voc\u00ea n\u00e3o tem permiss\u00e3o para editar essa resposta'); location.href='$url_edit';</script>");
	exit;
}
...
<html>
    <head>
        <meta charset="UTF-8">
        <title>Comunidade MutiN&iacute;vel | TALK FUSION | TRAFFICMONSOON | F&OacuteRUM D&uacute;vidas, Tutoriais e Conte&uacute;do t&eacute;cnico para nossos afiliados</title>
        ...
        <div class="wrapper row-offcanvas row-offcanvas-left">
            ...
            <aside class="right-side strech">
                ...
                <section class="content-header">
                    <h1> 
                        <small>Editando Sua Resposta, tira suas d&uacute;vidas, compartilhe seu conhecimento com outros internaltas.</small>
                    </h1>
                    <ol class="breadcrumb">  
...
<div class='row'>
                        ...
                        <div class='col-md-12'>
                            <div class='box box-info'>
                                <div class='box-header'>
                                    <h3 class='box-title'>Editar Resposta <small> \O/ </small></h3>
                                    <!-- tools box -->
                                ...
                                <div class='box-body pad'>
									<form id="form_res" name="form_res" method="post" action="editando_resposta.php">
										<div style="width:35%; float:left;"> 
										  
										</div>
										<div style="width:60%; float:right;"> 
											<textarea id="editor1" name="editor1" ><?php echo $texto_resposta; ?></textarea>
											<br> 
											<INPUT TYPE="hidden" NAME="id_cliente_edit" VALUE="<?php echo $id_cliente_edit; ?>">
											<INPUT TYPE="hidden" NAME="id_resposta_edit" VALUE="<?php echo $id_resposta_edit; ?>">
